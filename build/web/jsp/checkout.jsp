                        ...
                        <div class=" col-md-12 sm-padding-top-48px sm-margin-bottom-0 xs-margin-bottom-15px">
                            <div class="order-summary sm-margin-bottom-80px">
                                <div class="cart-list-box short-type">
                                                ...
                                                <div class="cart-item">
                                                    <div class="product-thumb">
                                                        <a class="prd-thumb" href="#">
                                                            <figure><img src="${cart.getBook().getImg()}" width="113" height="113" alt="shop-cart" ></figure>
                                                        </a>
                                                    </div>
                                                    <div class="info">
                                                        <span class="txt-quantity">${cart.getQuantity()}X</span>
                                                        <a href="#" class="pr-name">${cart.getBook().getName()}</a>
                                                    </div>
                                    ...
                                    <form action="CheckoutURL" name="frm-login" method="post">
                                        <p class="form-row">
                                            <b>Notes: </b> <input name="notes" type="text" style="width: 60%;" >
